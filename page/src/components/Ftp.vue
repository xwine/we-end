<template>
    <div>
        ...
        <div class="block" v-loading="loading"
            ...
            <el-button style="float: right" icon="el-icon-download"
                       size="mini"
                       type="text"
                       v-show="showUser == false"
                       @click="batchDownload"
    ...
    export default {
        ...
        methods: {
            ...
            batchDownload() {
                var that = this
                this.loading = true
                this.$http.get(that.GLB.batch_download, {params: {user: that.choseUser}}).then(response => {
            ...
            fetchFileData(index, row) {
                ...
                if (row.fileName.endWith(".json")) {
                    ...
                    this.$http.get(that.GLB.mock_get_remote_data, {
                        params: {
                            user: that.choseUser,
            ...
            download(index, row) {
                ...
                if (row.fileName.endWith(".json")) {
                    this.loading = true
                    this.fileName = row.fileName;
                    this.$http.get(that.GLB.mock_download, {
                        params: {
                            user: that.choseUser,
                            fileName: that.fileName
                        }
